# EXAMPLE USAGE:
# python run_autoencoder.py configs/layer10_batch_size1028.yaml
...
early_stopping_callback = EarlyStopping(
    ...
    mode="min",           # "min" because we want to reduce loss
...
trainer = L.Trainer(
    logger=wandb_logger, callbacks=[checkpoint_callback, early_stopping_callback], **config["trainer"]
)
